...
/**
 * description: MabatisPlusGenerator 需要com.baomidou.mybatis-plus-boot-starter 2.3版本，3.4版本会找不到包
...
public class MabatisPlusGenerator {
    ...
    //生成文件所在【项目】路径
    private static String baseProjectPath = "D:\\work";

    //基本包名
    private static String basePackage = "com.zbs.mybatisplus";
    //作者
    private static String authorName = "zhangbs";
    //要生成的表名
    ...
    private static String url = "jdbc:mysql://localhost:3306/mybatis_plus_demo?useUnicode=true&characterEncoding=utf8";
